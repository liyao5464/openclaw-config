...
调用量最少的 DeepSeek 被摆在第一位，调用量最大的 MiniMax 反而排在最后。这说明什么？

**Anthropic 最忌惮的，不是调用最多的，而是进步最快的。**

DeepSeek V2 那惊人的性价比，显然给 Anthropic 留下了深刻印象。
...
马斯克的意思很明确：你自己就是靠爬全网数据起家的，现在别人"蒸馏"一下你的输出，你就急了？

这完美呼应了评论区第一高赞（现在已经涨到 290 赞）：
...
*本文基于 Anthropic 官方推文及评论区公开内容整理。数据截至 2026-02-24，评论区最高赞已涨至 290。抓取工具：x-tweet-fetcher + Camofox。个人观点，欢迎讨论。*
